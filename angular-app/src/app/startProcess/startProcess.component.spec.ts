...
describe('startProcessComponent', () => {
  ...
  let mockstartProcessService;
  let mockDataService

  beforeEach(async(() => {

    mockstartProcessService = sinon.createStubInstance(startProcessService);
    mockstartProcessService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: startProcessService, useValue: mockstartProcessService },
