...
describe('createStaffComponent', () => {
  ...
  let mockcreateStaffService;
  let mockDataService

  beforeEach(async(() => {

    mockcreateStaffService = sinon.createStubInstance(createStaffService);
    mockcreateStaffService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: createStaffService, useValue: mockcreateStaffService },
